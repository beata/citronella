<?php
// load project's config.php to use project's session_name
$project_config = dirname(__FILE__) . '/../config/config.php';
file_exists($project_config) && require($project_config);
...
include(dirname(__FILE__) . "/configuration.php"); // Security functions
